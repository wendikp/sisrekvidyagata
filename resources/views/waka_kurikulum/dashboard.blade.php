      ...
      <div class="col-md-9">
        <div class="col-md-6">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Rombel IPA</span>
              <span class="info-box-number">{{ $jml_rombel_ipa }}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-6">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Rombel IPS</span>
              <span class="info-box-number">{{ $jml_rombel_ips }}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-6">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Rombel Bahasa</span>
              <span class="info-box-number">{{ $jml_rombel_bhs }}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-6">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Total Rombel ({{ $tahun_ajar_baru }})</span>
              <span class="info-box-number">{{ ($jml_rombel_ipa+$jml_rombel_ips+$jml_rombel_bhs) }}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{ url('/dashboard-waka-kurikulum/updateProfil') }}" role="form" method="POST">
              @csrf
              @foreach($data_waka as $data)
    ...
    <div class="modal fade" id="modal-password">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{ url('/dashboard-waka-kurikulum/gantiPassword') }}" role="form" method="POST">
              @csrf
...
<script>
  Highcharts.chart('barChart', {
    ...
    title: {
      text: 'Jumlah Rombel Setiap Tahun'
    },
    xAxis: {
    ...
    tooltip: {
      ...
      pointFormat: '<tr><td style="color:{series.color};padding:0">{series.name}: </td>' +
            '<td style="padding:0"><b>{point.y:.0f} rombel</b></td></tr>',
      footerFormat: '</table>',
      shared: true,
      useHTML: true
    },
    ...
    series: [{
      name: 'MIPA',
      data: {!! json_encode($rombel_ipa) !!}

    }, {
        name: 'IPS',
        data: {!! json_encode($rombel_ips) !!}

    }, {
        name: 'Bahasa Indonesia dan Budaya',
        data: {!! json_encode($rombel_bhs) !!}
