...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Daftar Rombel (Deleted)</li>
    </ol>
  </section>
      ...
      <div class="col-xs-12">
        <div class="box box-success">
          <div class="box-header with-border">
            <h3 class="box-title">Daftar Rombel (Deleted)</h3>
          </div><!-- /.box-header -->
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td width="85">
                    <div class="btn-group">
                    <a href="{{ url('/daftar_rombel_deleted/restore/'.$data->id) }}" class="btn btn-default" data-toggle="tooltip" title="Restore Rombel"><i class="fa fa-undo"></i></a>
                    </div>
                  </td>
                </tr>
                @endforeach
