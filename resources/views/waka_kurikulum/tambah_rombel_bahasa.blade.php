...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ url('/daftar_rombel_bhs') }}">Daftar Rombel Bahasa</a></li>
      ...
      <div class="col-xs-12">
        <div class="box box-success">
          <div class="box-header with-border">
            <h3 class="box-title">Form. Tambah Rombel Bahasa</h3>
          </div><!-- /.box-header -->
          <div class="box-body table-responsive">
          <form action="{{ url('/store_rombel')}}" role="form" method="POST">
              @csrf
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="form-group">
                          <input type="hidden" name="peminatan" value="bahasa">
