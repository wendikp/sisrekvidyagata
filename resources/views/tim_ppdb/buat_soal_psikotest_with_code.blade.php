...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <li><a href="{{ url('/daftar_psikotest/soal/'.$id_psikotest) }}">Soal</a></li>
      ...
      <div class="col-xs-12">
        <div class="box box-success">
          ...
          <div class="box-body table-responsive">
            <form action="{{ url('/daftar_psikotest/soal/tambah/simpan')}}" role="form" method="POST" enctype="multipart/form-data">
              @csrf
                ...
                <tbody>
                  ...
                  for ($i=0; $i < $jumlah; $i++) { 
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="hidden" name="kode" value="{{ $kode_soal }}">
