...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Nilai Perbandingan Berpasangan Bahasa</li>
    </ol>
  </section>
      ...
      <div class="col-xs-12">
        ...
        <div class="box box-success">
          <div class="box-header with-border">
            <h3 class="box-title">Form. Pengisian Nilai Perbandingan Berpasangan Bahasa</h3>
          ...
          <div class="box-body table-responsive">
            <form action="{{ url('/daftar_kriteria/hitung_CI_CR_bhs/'.$id)}}" role="form" method="POST">
              @csrf
