...
<body id="page-top">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto my-2 my-lg-0">
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#psikotest">Psikotest</a>
          </li>
          <li class="nav-item">
  ...
  <!-- Pengumuman Section -->
  <section class="page-section bg-light" id="psikotest">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-10 text-center">
          <h2 class="mt-0">Psikotest</h2>
          ...
          <div class="row">
            <div class="text-center mb-4">
              ...
              <br/>
              <a class="btn btn-info btn-xl js-scroll-trigger" href="#submit">Submit</a>
            </div>
          </div>
        </div>
      </div>
