      ...
      <div class="col-xs-12">
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Daftar Tim PPDB (Deleted)</h3>
          </div><!-- /.box-header -->
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td width="85">
                    <div class="btn-group">
                    <a href="{{ url('/restore_tim_ppdb/'.$data->id) }}" class="btn btn-default" data-toggle="tooltip" title="Restore Staf"><i class="fa fa-undo"></i></a>
                    </div>
                  </td>
                </tr>
                @endforeach
