...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Daftar Waka Kurikulum (Deleted)
    </h1>
    <ol class="breadcrumb">
      <li><a href="{{ url('/dashboard-admin') }}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
      <li class="active">Daftar Waka Kurikulum (Deleted)</li>
    </ol>
  </section>
      ...
      <div class="col-xs-12">
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Daftar Waka Kurikulum (Deleted)</h3>
          </div><!-- /.box-header -->
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td width="85">
                    <div class="btn-group">
                    <a href="{{ url('/restore_waka_kurikulum/'.$data->id) }}" class="btn btn-default" data-toggle="tooltip" title="Restore Staf"><i class="fa fa-undo"></i></a>
                    </div>
                  </td>
                </tr>
                @endforeach
