...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ url('/daftar_waka_kurikulum') }}">Daftar Waka Kurikulum</a></li>
      ...
      <div class="col-xs-12">
        <div class="box box-success">
          <div class="box-header with-border">
            <h3 class="box-title">Form. Tambah Waka Kurikulum</h3>
          </div><!-- /.box-header -->
          <div class="box-body table-responsive">
            <form action="{{ url('/insert_waka_kurikulum') }}" role="form" method="POST">
              @csrf
