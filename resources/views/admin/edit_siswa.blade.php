...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ url('/folder_siswa/daftar_siswa/'.$angkatan) }}">Daftar Siswa Angkatan {{ $angkatan }}/{{ $angkatan+1 }}</a></li>
      ...
      <div class="col-xs-12">
        <div class="box box-success">
          ...
          <div class="box-body table-responsive">
            <form action="{{ url('/update_siswa/'.$angkatan) }}" role="form" method="POST">
              @csrf
              ...
              <table class="table table-responsive table-condensed">
                ...
                <tr>
                  <div class="form-group">
                    ...
                    <td style="border: none;">:</td>
                    <td style="border: none;"><input type="text" class="form-control" name="asal_sekolah" value="{{ $data->asal_sekolah }}" style="width: 230px;" required="required"></td>
                  </div>
                </tr>
                <tr>
                  <div class="form-group">
                ...
                <td style="border: none;">Angkatan</td>
                  <td style="border: none;">:</td>
                  <td style="border: none;">
                    <input type="text" class="form-control" name="angkatan" value="{{ $data->angkatan }}" style="width: 230px;" required="required" data-inputmask='"mask": "9999"' data-mask placeholder="Ex: 2019">
                  </td>
                </tr>
                <tr>
